...
void pages_init(const char *path) {
  ...
  pages_base =
      mmap(0, NUFS_SIZE, PROT_READ | PROT_WRITE, MAP_SHARED, pages_fd, 0);
...
void *pages_get_page(int pnum) { return pages_base + 4096 * pnum; }

void *get_pages_bitmap() { return pages_get_page(0); }
